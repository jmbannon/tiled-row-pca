...
#define CHECK_CUSOLVER_RETURN(res, error)\
switch(res)\
{\
    case CUSOLVER_STATUS_SUCCESS: res = 0; break;\
    case CUSOLVER_STATUS_NOT_INITIALIZED: printf("\n ERROR: CUSOLVER_STATUS_NOT_INITIALIZED\n %s\n", error); return CUSOLVER_STATUS_NOT_INITIALIZED;\
    case CUSOLVER_STATUS_ALLOC_FAILED: printf("\n ERROR: CUSOLVER_STATUS_ALLOC_FAILED\n %s\n", error); return CUSOLVER_STATUS_ALLOC_FAILED;\
    case CUSOLVER_STATUS_INVALID_VALUE: printf("\n ERROR: CUSOLVER_STATUS_INVALID_VALUE\n %s\n", error); return CUSOLVER_STATUS_INVALID_VALUE;\
    case CUSOLVER_STATUS_ARCH_MISMATCH: printf("\n ERROR: CUSOLVER_STATUS_ARCH_MISMATCH\n %s\n", error); return CUSOLVER_STATUS_ARCH_MISMATCH;\
    case CUSOLVER_STATUS_EXECUTION_FAILED: printf("\n ERROR: CUSOLVER_STATUS_EXECUTION_FAILED\n %s\n", error); return CUSOLVER_STATUS_EXECUTION_FAILED;\
    case CUSOLVER_STATUS_INTERNAL_ERROR: printf("\n ERROR: CUSOLVER_STATUS_INTERNAL_ERROR\n %s\n", error); return CUSOLVER_STATUS_INTERNAL_ERROR;\
